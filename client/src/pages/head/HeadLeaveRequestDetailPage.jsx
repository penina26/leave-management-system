...
function HeadLeaveRequestDetailPage() {
    ...
    async function fetchLeaveRequestDetail() {
        try {
            ...
            const response = await api.get(`/head/leave-requests/${requestId}`, {
                headers: {
        ...
        <div className="space-y-8">
            ...
            <section className="rounded-3xl bg-gradient-to-r from-blue-700 to-blue-600 text-white p-8 shadow-sm">
                ...
                <p className="mt-3 text-blue-100 max-w-2xl">
                    Review the endorsed leave request carefully and decide whether to approve
                    or reject the final application.
                </p>
            </section>
                ...
                <section className="xl:col-span-2 bg-white border border-gray-200 rounded-2xl shadow-sm p-6">
                    <div className="mb-6">
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            Review the applicant details, request timeline, and supervisor context
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="rounded-xl bg-green-50 border border-green-100 p-4">
                            <div className="flex items-center gap-2 text-green-700 mb-2">
                                ...
                                <p className="text-sm font-medium">Final Approval Stage</p>
                            </div>
                            <p className="text-sm text-green-800 leading-6">
                                This request has already gone through supervisor review and is now
            ...
            {leaveRequest.status === "pending_head" && (
                <section className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6">
                    <div className="mb-6">
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            Add a comment and choose whether to approve or reject this request.
                        </p>
                    </div>
