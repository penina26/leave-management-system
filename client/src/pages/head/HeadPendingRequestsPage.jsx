...
import { FiCheckSquare, FiEye, FiInbox } from "react-icons/fi";
    ...
    useEffect(() => {
        async function fetchPendingLeaveRequests() {
            try {
                ...
                const response = await api.get("/head/leave-requests/pending", {
                    headers: {
    ...
    return (
        <div className="space-y-8">
            ...
            <section className="rounded-3xl bg-gradient-to-r from-blue-700 to-blue-600 text-white p-8 shadow-sm">
                ...
                <h1 className="text-3xl font-bold">Pending Approval Requests</h1>
                <p className="mt-3 text-blue-100 max-w-2xl">
                    Review endorsed leave requests submitted for final approval and open
                    each request to make a decision.
                </p>
            </section>
                ...
                <div className="px-6 py-5 border-b border-gray-200 flex items-center justify-between flex-wrap gap-3">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            Open a request below to review details and make a final decision.
                        </p>
                    </div>
                ...
                {loading ? (
                    ...
                    <div className="p-10 text-center">
                        ...
                        <p className="mt-2 text-sm text-gray-500 max-w-md mx-auto">
                            There are currently no leave requests waiting for your final
                            approval.
                        </p>
                    </div>
                ) : (
                            ...
                            <tbody className="divide-y divide-gray-200">
                                {leaveRequests.map((leaveRequest) => (
                                    <tr key={leaveRequest.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 text-gray-700">
                                            {leaveRequest.supervisor_name || "N/A"}
                                        </td>
                                        ...
                                        <td className="px-6 py-4 text-gray-700">
                                            {formatDateTime(leaveRequest.supervisor_action_at)}
                                        </td>

                                        <td className="px-6 py-4">
                                            <Link
                                                to={`/head/leave-requests/${leaveRequest.id}`}
