        ...
        <div className="space-y-8">
            ...
            <section className="rounded-3xl bg-gradient-to-r from-blue-700 to-blue-600 text-white p-8 shadow-sm">
                ...
                <p className="mt-3 text-blue-100 max-w-2xl">
                    Create a new role definition to control access permissions and workflow
                ...
                <section className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6">
                    <div className="mb-6">
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            Define the role name and describe the kind of access or workflow
                    ...
                    <div className="mt-6 rounded-xl border border-blue-100 bg-blue-50 p-4">
                        ...
                        <p className="text-sm text-blue-800 leading-6">
                            Use clear and consistent role names so access rules remain easy to
                            manage across users, approvals, and administrative workflows.
                        </p>
                    </div>
                </section>
