        ...
        <div className="space-y-8">
            ...
            <section className="rounded-3xl bg-gradient-to-r from-blue-700 to-blue-600 text-white p-8 shadow-sm">
                ...
                <p className="mt-3 text-blue-100 max-w-2xl">
                    Update the unit details and change the assigned head of unit where necessary.
                </p>
            </section>
                ...
                <section className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6">
                    <div className="mb-6">
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            Update the unit name, description, and assigned head of unit.
                        </p>
                    </div>
                    ...
                    <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="rounded-xl border border-blue-100 bg-blue-50 p-4">
                            ...
                            <p className="text-sm text-blue-800 leading-6">
                                Keep unit information aligned with the organizational structure used in the leave workflow.
                            </p>
                        </div>
