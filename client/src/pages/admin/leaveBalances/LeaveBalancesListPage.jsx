        ...
        <div className="space-y-8">
            ...
            <section className="rounded-3xl bg-gradient-to-r from-blue-700 to-blue-600 text-white p-8 shadow-sm">
                ...
                <p className="mt-3 text-blue-100 max-w-2xl">
                    Review staff leave balance records, compare allocated versus used days,
                    and update balances where necessary.
                </p>
            </section>
                ...
                <section className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm text-gray-500">Balance Records</p>
                ...
                <div className="px-6 py-5 border-b border-gray-200 flex items-center justify-between flex-wrap gap-3">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            Review leave balances by user, leave type, and year, then open any
                            record to update it.
                        </p>
                    </div>
                ...
                {loading ? (
                    ...
                    <div className="p-10 text-center">
                        ...
                        <p className="mt-2 text-sm text-gray-500 max-w-md mx-auto">
                            No leave balance records are currently available. Once balances are
                            configured, they will appear here.
                        </p>
                    </div>
                ) : (
                            ...
                            <tbody className="divide-y divide-gray-200">
                                {leaveBalances.map((balance) => (
                                    <tr key={balance.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4">
                                            <Link
                                                to={`/admin/leave-balances/${balance.id}/edit`}
