        ...
        <div className="space-y-8">
            ...
            <section className="rounded-3xl bg-gradient-to-r from-blue-700 to-blue-600 text-white p-8 shadow-sm">
                ...
                <p className="mt-3 text-blue-100 max-w-2xl">
                    Define a new leave type, configure default leave days, and control
                    whether it uses leave balance tracking and remains active in the system.
                </p>
            </section>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                <section className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6">
                    <div className="mb-6">
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            Enter the leave type details and define its default configuration.
                        </p>
                    </div>
                ...
                <section className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6">
                    <div className="mb-6">
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            Configure whether this leave type uses balances and whether it is active.
                        </p>
                    </div>
                    ...
                    <div className="mt-6 rounded-xl border border-blue-100 bg-blue-50 p-4">
                        ...
                        <p className="text-sm text-blue-800 leading-6">
                            Leave types that require balances will typically reduce from the
                            employee’s allocated leave days. Inactive leave types remain in the
                            system but should not be used for new requests.
                        </p>
                    </div>
                </section>
                ...
                <div className="flex items-center justify-end gap-3">
                    ...
                    >
                        ...
                        {submitting ? "Creating Leave Type..." : "Create Leave Type"}
                    </button>
                </div>
            </form>
        </div>
